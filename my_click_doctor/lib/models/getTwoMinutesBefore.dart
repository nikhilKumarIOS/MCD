class getTwoMinutesBefore {
  List<TodayAppList> todayAppList;
  var msg;
  var code;
  var path;
  var userId;
  ...
  getTwoMinutesBefore.fromJson(Map<String, dynamic> json) {
    if (json['todayAppList'] != null) {
      todayAppList = <TodayAppList>[];
      json['todayAppList'].forEach((v) {
        todayAppList.add(TodayAppList.fromJson(v));
      });
    }
    msg = json['msg'];
    code = json['code'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (todayAppList != null) {
      data['todayAppList'] = todayAppList.map((v) => v.toJson()).toList();
    }
    data['msg'] = this.msg;
    data['code'] = this.code;
    data['path'] = this.path;
...
class TodayAppList {
  ...
  TodayAppList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    data = json['data'];
    if (json['expert'] != null) {
      expert = new List<Expert>();
      json['expert'].forEach((v) {
        expert.add(new Expert.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['data'] = this.data;
    if (this.expert != null) {
      data['expert'] = this.expert.map((v) => v.toJson()).toList();
    }
...
class Expert {
  ...
  Expert.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    yearOfDiploma = json['yearOfDiploma'];
    nameofDegree = json['nameofDegree'];
    university = json['university'];
    specialization = json['specialization'];
    hungName = json['hungName'];
    remark = json['remark'];
    userId = json['userId'];
    catId = json['catId'];
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['id'] = this.id;
    data['yearOfDiploma'] = this.yearOfDiploma;
    data['nameofDegree'] = this.nameofDegree;
    data['university'] = this.university;
    data['specialization'] = this.specialization;
    data['hungName'] = this.hungName;
    data['remark'] = this.remark;
    data['userId'] = this.userId;
