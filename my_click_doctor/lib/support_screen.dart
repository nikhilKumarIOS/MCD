...
class SupportScreen extends StatefulWidget {
  ...
  @override
  State<SupportScreen> createState() => _SupportScreenPageState();
}

class _SupportScreenPageState extends State<SupportScreen> {
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: ClipOval(
                                              child: Material(
                                                color: const Color.fromARGB(216,
                                                    2, 7, 29), // Button color
                                                child: InkWell(
                                                  splashColor: Colors
                                                      .black, // Splash color
                                          ...
                                          Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(height: 5),
                                                Text(
                                                    'The support is available from 8 to 18:00 \nfrom Monday to Friday.',
                                                    style: TextStyle(
                                                      fontSize: w / 40,
                                                      fontWeight:
                                                          FontWeight.w500,
  ...
  //                                   'Lorem ipsum dolor sit amet, consectetur adipisc-ing elit. Suspendisse condimentum hendreritfelis, eu posuere magna gravida non. Nunc quisquam in massa rutrum mattis...',
  //                                   style: TextStyle(
  //                                       color: Colors.white, fontSize: w / 37),
  //                                 ),
  //                               )),
  //                           SizedBox(
  //                             height: 5,
  ...
  //                                     '10:00 AM',
  //                                     style: TextStyle(
  //                                         color: Colors.grey, fontSize: w / 37),
  //                                   ),
  //                                 ],
  //                               ))
  //                         ],
