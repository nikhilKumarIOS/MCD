...
class UIHelper {
  ...
  static const double _VerticalSpaceMediumPlus = 40.0;
  static const double _VerticalSpaceLarge = 60.0;

  // Vertical spacing constants. Adjust to your liking.
  static const double _HorizontalSpaceSmall = 10.0;
  static const double _HorizontalSpaceMedium = 20.0;
  static const double _HorizontalSpaceMediumPlus = 40.0;
  ...
  static const Widget horizontalSpaceMediumPlus =
      SizedBox(width: _HorizontalSpaceMediumPlus);
